class Solution:
    def isHappy(self, n: int) -> bool:
        seen=set()
        while n !=1 and n not in seen: # this condition will lead to returning of false,check for n not 1 and n not seen that is new elements not the repatedd ones 
            seen.add(n)
